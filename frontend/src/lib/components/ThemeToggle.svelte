...
<label class="swap swap-rotate btn btn-ghost btn-circle select-none" style="-webkit-tap-highlight-color: transparent;">
	<input type="checkbox" checked={isDark} onchange={toggleTheme} class="hidden" />
